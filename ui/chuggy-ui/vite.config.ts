...
export default defineConfig({
  ...
  test: {
     ...
     * also runs inside the worker image's build, where vitest's workers share
     * the profile's few CPUs with everything else the roster starts, and the
     * model walk over a capped store went past vitest's default there while
     * passing here in a fraction of it. What the cap is for is a test that
