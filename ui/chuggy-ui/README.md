...
a bill. The situation column holds exactly the wall and the actions with their
costs; the brief, the provenance and the configuration are in the main body
under the ledger, reached by the details pane's anchors rather than by tabs.
