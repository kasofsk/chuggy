 ...
 * condition that excluded it would abort the loop before its first sleep was
 * up. `sleepMs` is instant here, so the interval is not what is being checked;
...
async function heldEntryAfter(
  ...
  client.setQueryData(held, { ticket: 3, state: "Working" });
  render(
