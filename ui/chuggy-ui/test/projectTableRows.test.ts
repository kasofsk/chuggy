...
test("a row's title is the ticket's own, and absent where the wire names none", () => {
  expect(
    projectTableRow({ ...working, title: "Fix the importer" }, undefined, false)
      .title,
  ).toBe("Fix the importer");
