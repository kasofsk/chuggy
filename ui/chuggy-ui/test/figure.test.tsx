...
const everyKind: readonly FigureValue[] = [
  ...
  { kind: "Ago", text: "55m ago", full: "2026-08-27 10:12" },
  {
    kind: "Span",
    start: "10:19",
    end: "10:49",
...
test("an ago reading hovers its full date and clock", async () => {
  render(
    <Figure figure={{ kind: "Ago", text: "55m ago", full: "2026-08-27 10:12" }} />,
  );
  fireEvent.focus(screen.getByText("55m ago"));
  expect((await screen.findByRole("tooltip")).textContent).toBe(
    "2026-08-27 10:12",
  );
});
