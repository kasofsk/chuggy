...
A job orchestrator: tickets form a DAG, a single journaled actor drives each through authoring → work → evaluation → wrap-up, and the fabric runs the work and decides nothing.
