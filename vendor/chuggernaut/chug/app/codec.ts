...
import * as evaluation from "../domain/evaluation.js";
import * as ticket from "../domain/ticket.js";
...
export class Variants<T> {
  ...
  constructor(readonly union: string) {}
}
...
function unicode_order(left: string, right: string): number {
