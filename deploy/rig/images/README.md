...
| `CHUG_API_OIDC_ALGORITHMS` | required | comma-separated, surrounding spaces trimmed; every entry must be one of `EdDSA`, `ES256`, `ES384`, `ES512`, `Ed25519`, `PS256`, `PS384`, `PS512`, `RS256`, `RS384`, `RS512`, and anything else — a shared-secret algorithm, `none`, a name with a typo — refuses to start |
