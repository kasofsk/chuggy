 ...
 * commit; a repeated dispatch is two `DispatchTicket` commands at their own
 * prefixes, the second refused `TicketNotPending` for a ticket the first left
 * in `Work` — a refusal the lead did not earn.
 */
