...
/**
 * What the pod is launched with, which is what no callback can hand it. Every
 * other byte of material the run needs is fetched from the callback under the
 * bearer, and a pool holds no identity to add to it.
 */
