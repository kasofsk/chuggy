...
const baselineControls = {
  ...
  toolAllowlist: [
    ...
    "mcp__chuggy__read_draft",
    "mcp__chuggy__list_drafts",
    "mcp__chuggy__list_configurations",
    "mcp__chuggy__read_configuration",
    ...
    "mcp__chuggy__initialize_draft",
    "mcp__chuggy__file_dependent",
    "mcp__chuggy__revise_draft",
    "mcp__chuggy__delete_draft",
    "mcp__chuggy__release_draft",
