...
async function updateInstalledPrivileges(subject: pg.Pool): Promise<void> {
  for (const [relation, column, role, privilege, granted] of [
    ...
    ["ticket_definition", "brief", apiRole, "SELECT", true],
    ["ticket_definition", "ticket", apiRole, "SELECT", true],
    ["ticket_definition", "definition", apiRole, "SELECT", false],
    ["ticket_definition", "digest", apiRole, "SELECT", false],
